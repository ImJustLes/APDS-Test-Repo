...
const UseLogin = () => {
    ...
    return (
        <form onSubmit={handleLogin}>
            ...
            <button type="button" onClick={() => navigate('/register')} style={{ padding: '10px 20px', margin: '20px' }}>Register</button>

            <button type="button" onClick={() => navigate('/elogin')} style={{ padding: '10px 20px', margin: '20px' }}>Employee Login</button>
        </form>
    )
